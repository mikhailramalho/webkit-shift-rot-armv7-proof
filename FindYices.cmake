...
function(check_yices_version yices_include yices_lib)
  ...
  try_run(
    ...
    YICES_COMPILED
    ${CMAKE_BINARY_DIR}
    ${CMAKE_SOURCE_DIR}/try_yices.cpp
  ...
  if(NOT YICES_COMPILED)
    message(FATAL_ERROR "Yices lib found in ${yices_lib_path} but test compilation failed: ${SRC_OUTPUT}")
  endif()
...
find_path(CAMADA_YICES_INCLUDE_DIR yices.h HINTS ${CAMADA_YICES_DIR} $ENV{HOME}/yices PATH_SUFFIXES include)

find_library(CAMADA_YICES_LIB yices HINTS ${CAMADA_YICES_DIR} $ENV{HOME}/yices PATH_SUFFIXES lib bin)
